...
This page is part of my interactive portfolio and rrsume, built using Streamlit. It automatically pulls information from my GitHub repositories so that the projects and experience shown here stay current as I continue to grow and update my work.
